...
= 1.1.0 =
* Track attribution-bearing visits on all pages, not just product pages, so AI-referred sessions that land off a product page are still attributed.

= 1.0.4 =
* Add status endpoint so the Channel3 connect flow can detect the plugin before redirecting.

= 1.0.2 =
* Improved script and style registration.
* Connection time validation fixes.
