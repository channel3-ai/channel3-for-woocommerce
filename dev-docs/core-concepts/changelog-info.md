...
```php
*** WooCommerce Extension Name Changelog ***YYYY-MM-DD - version 1.1.0* Added - Useful new feature    * A second new feature    * A third new feature* Fixed - Important bug fix* Update - Compatibility with latest versionYYYY-MM-DD - version 1.0.1* Fixed a bugYYYY-MM-DD - version 1.0.0* Initial release
```
